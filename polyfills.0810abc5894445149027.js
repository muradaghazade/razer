    ...
    [2], {
        "0TWp": function(e, t, n) {
            ...
            void 0 === (o = "function" == typeof(r = function() {
                ...
                ! function(e) {
                        ...
                        return t.assertZonePatched = function() {
                            ...
                            if (e.state !== b || e.type !== Z && e.type !== P) {
                                ...
                                try {
                                    ...
                                    e.state !== b && e.state !== S && (e.type == Z || e.data && e.data.isPeriodic ? r && e._transitionTo(T, E) : (e.runCount = 0, this._updateTaskCount(e, -1), r && e._transitionTo(b, E, b))), C = C.parent, z = o
                                }
                            }
                    ...
                    function w(e, r, a) {
                        ...
                        if (e[d] === m) {
                            ...
                            if (r !== k && a instanceof D && a.hasOwnProperty(d) && a.hasOwnProperty(v) && a[d] !== m) O(a), w(e, a[d], a[v]);
                                ...
                                e[d] = r;
                                var p = e[v];
                                if (e[v] = a, e[g] === g && r === b && (e[d] = e[_], e[v] = e[y]), r === k && a instanceof Error) {
                                ...
                                if (0 == p.length && r == k) {
                                    ...
                                    Z.rejection = a, Z.promise = e, Z.zone = t.current, Z.task = t.currentTask, i.push(Z), n.scheduleMicroTask()
                                }
                            }
                        }
                        return e
                    ...
                    z && !z.configurable || (z && delete z.writable, z && delete z.value, z || (z = {
                        ...
                        t === D ? e[C] = t : (e[s] = t, t.prototype[l] || R(t), n.setNativePromise(t))
                    }, o(e, "Promise", z)), e.Promise = D;
                    var I, M = a("thenPatched");
                    ...
                    if (n.patchThen = R, j) {
                        R(j);
                        var L = e.fetch;
                        "function" == typeof L && (e[n.symbol("fetch")] = L, e.fetch = (I = L, function() {
                ...
                var k = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
                    ...
                    w = void 0 !== y.process && "[object process]" === {}.toString.call(y.process) && !k && !(!v || !g.HTMLElement),
                    S = {},
                    O = function(e) {
                        if (e = e || y.event) {
                            var t = S[e.type];
                    ...
                    if (n) {
                        ...
                        for (r in o) "XMLHttpRequest" === e && "responseBlob" === r || function(n) {
                            "function" == typeof o[n] ? y[e].prototype[n] = function() {
                                ...
                                set: function(t) {
                                    "function" == typeof t ? (this[D][n] = p(t, e + "." + n), I(this[D][n], t)) : this[D][n] = t
                                },
                                get: function() {
                                    return this[D][n]
                                }
                ...
                function C(t, r, o) {
                    ...
                    var i = d(r),
                        c = null;
                    if (a && !(c = a[i]) && (c = a[i] = a[r], b(a && e(a, r)))) {
                        var s = o(c, i, r);
                        a[r] = function() {
                ...
                function N() {
                    ...
                    M = !0;
                    try {
                        var e = g.navigator.userAgent; - 1 === e.indexOf("MSIE ") && -1 === e.indexOf("Trident/") && -1 === e.indexOf("Edge/") || (R = !0)
                    } catch (t) {}
                    return R
                }
                ...
                function U(e, t, r) {
                            ...
                            if (t = t || e.event) {
                                ...
                                if (r)
                                    if (1 === r.length) g(r[0], n, t);
                                        ...
                                        for (var o = r.slice(), a = 0; a < o.length && (!t || !0 !== t[W]); a++) g(o[a], n, t)
                            }
                        },
                        _ = function(t) {
                            if (t = t || e.event) {
                    ...
                    function m(t, r) {
                        ...
                        function D(e, t) {
                            return !x && "object" == typeof e && e ? !!e.capture : x && t ? "boolean" == typeof e ? {
                                capture: e,
                                passive: !0
                        ...
                        var j = a ? function(e) {
                            ...
                            L = function(t, n, o, c, s, f) {
                                return void 0 === s && (s = !1), void 0 === f && (f = !1),
                                    function() {
                                        var p = this || e,
                                            h = arguments[0];
                                        ...
                                        if (!i || i(t, d, p, arguments)) {
                                            ...
                                            var I = p.constructor.name,
                                                L = B[I];
                                            L && (P = L[h]), P || (P = I + n + (E ? E(h) : h)), w.options = _, k && (w.options.once = !1), w.target = p, w.capture = b, w.eventName = h, w.isExisting = C;
                                            var N = a ? F : void 0;
                                            N && (N.taskData = w);
                                            var A = S.scheduleEventTask(P, d, N, o, c);
                                            return w.target = null, N && (N.taskData = null), k && (_.once = !0), (x || "boolean" != typeof A.options) && (A.options = _), A.target = p, A.capture = b, A.eventName = h, v && (A.originalDelegate = d), f ? j.unshift(A) : j.push(A), s ? p : void 0
                                        }
                                    }
                            };
                        return b[o] = L(S, v, j, C, m), k && (b.prependListener = L(k, ".prependListener:", (function(e) {
                            ...
                            if (!i || i(O, c, t, arguments)) {
                                ...
                                if (h)
                                    for (var d = 0; d < h.length; d++) {
                                        var v = h[d];
                                        if (z(v, c)) return h.splice(d, 1), v.isRemoved = !0, 0 === h.length && (v.allRemoved = !0, t[s] = null, "string" == typeof n && (t[f + "ON_PROPERTY" + n] = null)), v.zone.cancelTask(v), m ? t : void 0
                                    }
                            ...
                            if (n) {
                                ...
                                if (o) {
                                    ...
                                    if (a) {
                                        var s = a.slice();
                                        for (f = 0; f < s.length; f++) this[c].call(this, n, (l = s[f]).originalDelegate ? l.originalDelegate : l.callback, l.options)
                                    }
                                    if (i)
                                        for (s = i.slice(), f = 0; f < s.length; f++) {
                                            var l;
                                            this[c].call(this, n, (l = s[f]).originalDelegate ? l.originalDelegate : l.callback, l.options)
                                        }
                                }
                            } else {
                            ...
                            if (m) return this
                        }, I(b[o], S), I(b[c], O), Z && I(b[p], Z), P && I(b[s], P), !0
                    }
                ...
                var J, K, $, Q, ee, te = ["absolutedeviceorientation", "afterinput", "afterprint", "appinstalled", "beforeinstallprompt", "beforeprint", "beforeunload", "devicelight", "devicemotion", "deviceorientation", "deviceorientationabsolute", "deviceproximity", "hashchange", "languagechange", "message", "mozbeforepaint", "offline", "online", "paint", "pageshow", "pagehide", "popstate", "rejectionhandled", "storage", "unhandledrejection", "unload", "userproximity", "vrdisplayconnected", "vrdisplaydisconnected", "vrdisplaypresentchange"],
                ...
                function he(e, t) {
                    if ((!T || w) && !Zone[e.symbol("patchEvents")]) {
                        ...
                        if (E) {
                            ...
                            pe(a, ue.concat(["messageerror"]), o ? o.concat(i) : o, n(a)), pe(Document.prototype, ue, o), void 0 !== a.SVGElement && pe(a.SVGElement.prototype, ue, o), pe(Element.prototype, ue, o), pe(HTMLElement.prototype, ue, o), pe(HTMLMediaElement.prototype, ne, o), pe(HTMLFrameSetElement.prototype, te.concat(oe), o), pe(HTMLBodyElement.prototype, te.concat(oe), o), pe(HTMLFrameElement.prototype, re, o), pe(HTMLIFrameElement.prototype, re, o);
                            var c = a.HTMLMarqueeElement;
                            c && pe(c.prototype, ae, o);
                            var s = a.Worker;
                            s && pe(s.prototype, le, o)
                        }
                        var l = t.XMLHttpRequest;
                        l && pe(l.prototype, ie, o);
                        var u = t.XMLHttpRequestEventTarget;
                        u && pe(u && u.prototype, ie, o), "undefined" != typeof IDBIndex && (pe(IDBIndex.prototype, ce, o), pe(IDBRequest.prototype, ce, o), pe(IDBOpenDBRequest.prototype, ce, o), pe(IDBDatabase.prototype, ce, o), pe(IDBTransaction.prototype, ce, o), pe(IDBCursor.prototype, ce, o)), r && pe(WebSocket.prototype, se, o)
                    }
                }

                function de() {
                    J = Zone.__symbol__, K = Object[J("defineProperty")] = Object.defineProperty, $ = Object[J("getOwnPropertyDescriptor")] = Object.getOwnPropertyDescriptor, Q = Object.create, ee = J("unconfigurables"), Object.defineProperty = function(e, t, n) {
                ...
                function ye(e, t, n) {
                    return Object.isFrozen(n) || (n.configurable = !0), n.configurable || (e[ee] || Object.isFrozen(e) || K(e, ee, {
                        writable: !0,
                        value: {}
                    }), e[ee] && (e[ee][t] = !0)), n
                }
                ...
                function me(e, t) {
                    ...
                    for (var h = e.__Zone_disable_IE_check || !1, d = e.__Zone_enable_cross_context_check || !1, v = t.isIEOrEdge(), g = "[object FunctionWrapper]", y = "function __BROWSERTOOLS_CONSOLE_SAFEFUNC() { [native code] }", _ = {
                    ...
                    o = C(e, t += r, (function(n) {
                        return function(o, a) {
                            if ("function" == typeof a[0]) {
                                ...
                                return "number" == typeof u ? i[u] = l : u && (u[ke] = l), u && u.ref && u.unref && "function" == typeof u.ref && "function" == typeof u.unref && (l.ref = u.ref.bind(u), l.unref = u.unref.bind(u)), "number" == typeof u || u ? u : l
                            }
                            return n.apply(e, a)
                        }
                    })), a = C(e, n, (function(t) {
                        return function(n, r) {
                            var o, a = r[0];
                            "number" == typeof a ? o = i[a] : (o = a && a[ke]) || (o = a), o && "string" == typeof o.type ? "notScheduled" !== o.state && (o.cancelFn && o.data.isPeriodic || 0 === o.runCount) && ("number" == typeof a ? delete i[a] : a && (a[ke] = null), o.zone.cancelTask(o)) : t.apply(e, r)
                        }
                    }))
                }
                ...
                Zone.__load_patch("legacy", (function(e) {
                    ...
                    for (var n = ["alert", "prompt", "confirm"], r = 0; r < n.length; r++) C(e, n[r], (function(n, r, o) {
                        return function(r, a) {
                    ...
                    r && r.prototype && n.patchEventTarget(e, [r.prototype]), j("MutationObserver"), j("WebKitMutationObserver"), j("IntersectionObserver"), j("FileReader")
        ...
        "N/DB": function(e, t) {
            ...
            function i(e, t) {
                ...
                for (var c = i(t[0], t.raw[0]), s = 1; s < t.length; s++) c += r[s - 1] + i(t[s], t.raw[s]);
                return c
            }
        },
        "hN/g": function(e, t, n) {
